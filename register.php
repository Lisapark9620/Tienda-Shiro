...
<head>
    ...
    <title>Registro - Restaurante Gourmet</title>
        ...
        <div class="form-body">
            <?php if (isset($_GET['error'])): ?>
                <div class="alert alert-danger" role="alert" style="margin-bottom: 1.5rem;">
                    <?php 
                    switch($_GET['error']) {
                        case 'email_exists': echo 'Este correo electrónico ya está registrado'; break;
                        case 'db_error': echo 'Error de base de datos'; break;
                        default: echo 'Error de registro';
                    }
                    ?>
                </div>
            <?php endif; ?>
